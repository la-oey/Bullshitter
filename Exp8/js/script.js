...
function distributePseudo(totalTrials, minArrPseudo, maxArrPseudo){
    ...
    for(var o=0; o<arrPseudo.length; o++){
        index = Math.floor(randomDouble(0, bucket.length));
        pseudoDict[(bucket.splice(index, 1)[0])] = arrPseudo[o];
    }
