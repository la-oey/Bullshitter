...
#   eta.L = 0
#   #print(iter)
#   p_t.ksay.r(util, alph, eta.L, p, 
#              iterate.D(iter, util, alph, p, prior))
# }
# 
...
#   eta.D = 0
#   ifelse(iter == 0, prior, 
#          mapply(p.D_bs.ksay.r,
#                 0:10, p, util, alph, eta.D, lastlvl=FALSE, 
#                 iterate.L((iter - 1), util, alph, p, prior)))
#   # if(iter == 0){
#   #   return(prior)
#   # } else{
